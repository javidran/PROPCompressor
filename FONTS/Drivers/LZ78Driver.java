                ...
                switch (comando) {
                    ...
                    case "1":
                        ...
                        if (s.endsWith(".txt")) {
                            ...
                            entrada.read(data);
                            entrada.close();
                            OutputAlgoritmo oa = LZ78.getInstance().comprimir(data);
                    ...
                    case "2":
                        ...
                        System.out.println("Escriba el path relativo de un fichero .lz78 a descomprimir:");
                        s = System.getProperty("user.dir");
                        s += s.contains("/")?"/":"\\";
                        s += scanner.nextLine();
                        if (s.endsWith(".lz78")) {
                            ...
                            entrada.read(data);
                            entrada.close();
                            OutputAlgoritmo oa = LZ78.getInstance().descomprimir(data);
